...
namespace Common.Repository.SqlServerProvider
{
    public class ClaimsGenerator
    {
        ...
        private SqlOrgUserRepo _orgUserRepo;
        private SqlGlobalUserRoleRepo _orgGlobalUserRoleRepo;
        private SqlOrgUserRoleRepo _orgUserRoleRepo;
        private SqlOrgAppUserAuthIpRepo _orgAppUserAuthIpRepo;
        private SqlOrgAppUserRoleRepo _orgAppUserRoleRepo;
        private SqlOrgAppUserMetadataRepo _orgAppUserMetadata;
        public SqlServerClaimsGenerator(User user,
                                        ClaimsIdentity aAuthIdentity,
                                        IRepository<OrgUser> orgUserRepo,
                                        RepositoryBase<OrgUserRole> orgUserRoleRepo,
        ...
        {
            _orgGlobalUserRoleRepo = (SqlGlobalUserRoleRepo)orgGlobalUserRoleRepo;
            _orgUserRepo = (SqlOrgUserRepo)orgUserRepo;
            _orgUserRoleRepo = (SqlOrgUserRoleRepo)orgUserRoleRepo;
            _orgAppUserAuthIpRepo = (SqlOrgAppUserAuthIpRepo)orgAppUserAuthIpRepo;
            _orgAppUserRoleRepo = (SqlOrgAppUserRoleRepo)orgAppUserRoleRepo;
            _user = user;
            _oAuthIdentity = aAuthIdentity;
            _orgAppUserMetadata = (SqlOrgAppUserMetadataRepo)orgAppUserMetadata;
        }
